...
- (void)viewDidLoad
{
    ...
    MovieInfo *Movie8 = [[MovieInfo alloc] initWithMovieName:@"Crazy Crazy Movie" mImage:@"img" mTimes:[NSArray arrayWithObjects:@"12:15pm ", @"1:00pm ", @"8:10pm",nil]];
...
//    NSString *movieTimesConvertedtoString = [movieTimes description];
    NSMutableString * result = [[NSMutableString alloc] init];
    for (NSObject * obj in movieTimes)
    {
